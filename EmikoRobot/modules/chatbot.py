...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            ...
            return
        await lel.edit(
            f"Shiro AI Actived by {message.from_user.mention()} for users in {message.chat.title}"
        )
        ...
        if not Escobar:
            ...
            return
        await lel.edit(
            f"Shiro AI Deactivated by {message.from_user.mention()} for users in {message.chat.title}"
        )
...
@pbot.on_message(
    filters.regex("Shiro|shiro|SHIRO|robot|bot|Wiki|wiki")
    & ~filters.bot
    & ~filters.via_bot
    & ~filters.forwarded
    & ~filters.reply
